...
<p align="left">
Hey there, In this repo I have built a simple tic-tac-toe game that you play with terminal
and state of the game shows up in terminal. Actually, It wouldn't be wrong we said that, 
This game focuses on only the logic of the game. If you have any questions, You can find
